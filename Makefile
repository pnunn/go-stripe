STRIPE_SECRET=sk_test_dowTjfu0YyTszRI47qYV0sTa
STRIPE_KEY=pk_test_6oqsofc2sazbHrgCQcfAeiE4
GOSTRIPE_PORT=4002
API_PORT=4001
DSN=root@tcp(192.168.44.93:3306)/widgets?parseTime=true&tls=false
